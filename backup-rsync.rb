...
$CONFIGS = [
	...
	},
	{
		'active' => 'true',
		'client_user' => 'root',
		'client_host' => 'kubernetes-backup.sm.benjamin-borbe.de',
		'client_port' => '2222',
		'client_dir' => '/data/',
		'exclude_from' => '/root/scripts/backup-rsync-exclude-nop',
	},
	...
	},
	{
		'active' => 'true',
		'client_user' => 'root',
		'client_host' => 'pfsense.rn.benjamin-borbe.de',
		'client_port' => '22',
		'client_dir' => '/',
		'exclude_from' => '/root/scripts/backup-rsync-exclude-linux',
	},
	{
		'active' => 'true',
		'client_user' => 'root',
		'client_host' => 'pfsense.sm.benjamin-borbe.de',
		'client_port' => '22',
		'client_dir' => '/',
		'exclude_from' => '/root/scripts/backup-rsync-exclude-linux',
	},
	...
	},
	{
		'active' => 'true',
		'client_user' => 'root',
		'client_host' => 'ipfire.sm.benjamin-borbe.de',
		'client_port' => '22',
		'client_dir' => '/',
		'exclude_from' => '/root/scripts/backup-rsync-exclude-linux',
	},
	{
		'active' => 'true',
		'client_user' => 'root',
		'client_host' => 'host.sm.benjamin-borbe.de',
		'client_port' => '22',
		'client_dir' => '/',
		'exclude_from' => '/root/scripts/backup-rsync-exclude-linux',
	},
